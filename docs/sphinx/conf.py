...
latex_documents = [
    (master_doc, 'pydrp.tex', u'pydrp Documentation',
...
man_pages = [
    (master_doc, 'pydrp', u'pydrp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pydrp', u'pydrp Documentation',
     author, 'pydrp', 'One line description of project.',
     'Miscellaneous'),
]
